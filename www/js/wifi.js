...
$(document).ready( function() {
    ...
    navigator.wifi.getWifiInfo(onWifiScanSuccess, onWifiScanFail);

});

var onWifiScanSuccess = function(){
    app.display('scan success');
};

var onWifiScanFail = function(){
    app.display('scan fail');
};
